    ...
    >
      <div className="bg-white shadow-2xl rounded-b-[2rem] border-t border-gray-100 flex flex-col gap-1 p-5 font-bold text-gray-700 text-base max-h-[85vh] overflow-y-auto">
        ...
        <div className="flex flex-col">
          ...
          {/* CSS Grid Trick (ANTI-LAG) */}
          <div className={`grid transition-all duration-300 ease-out ${activeDropdown === 'm-profil' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
        ...
        <div className="flex flex-col">
          ...
          {/* CSS Grid Trick (ANTI-LAG) */}
          <div className={`grid transition-all duration-300 ease-out ${activeDropdown === 'm-layanan' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
            <div className="overflow-hidden">
              <div className="bg-gray-50 rounded-2xl mx-2 flex flex-col py-2 border border-gray-100 mt-1 mb-2">
        ...
        <div className="flex flex-col">
          ...
          {/* CSS Grid Trick (ANTI-LAG) */}
          <div className={`grid transition-all duration-300 ease-out ${activeDropdown === 'm-informasi' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
            <div className="overflow-hidden">
              <div className="bg-gray-50 rounded-2xl mx-2 flex flex-col py-2 border border-gray-100 mt-1 mb-2">
