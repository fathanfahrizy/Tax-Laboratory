  ...
  return (
    ...
    <main className="pt-32 pb-32 min-h-screen bg-[#fafafa] font-sans text-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        {/* CONTACT GRID */}
        <section aria-label="Jalur Komunikasi Laboratorium" className="grid md:grid-cols-2 gap-8 mb-20">
          
          {/* Card Email */}
          <ContactCard delay={0}>
            <article className="group bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-200/50 hover:border-purple-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col items-center text-center h-full transform-gpu">
          ...
          <ContactCard delay={200}>
            <article className="group bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-200/50 hover:border-orange-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col items-center text-center h-full transform-gpu">
